pub fn generate_metric_lines() -> Vec<String> {
    ...
    lines.push(String::from("response_time_bucket{env=\"production\",le=\"0.05\"} 25"));
    lines.push(String::from("response_time_bucket{env=\"production\",le=\"0.1\"} 57"));
    lines.push(String::from("response_time_bucket{env=\"production\",le=\"0.25\"} 148"));
    lines.push(String::from("response_time_bucket{env=\"production\",le=\"0.5\"} 319"));
    ...
    lines.push(String::from("response_time_bucket{env=\"testing\",le=\"0.05\"} 31"));
    lines.push(String::from("response_time_bucket{env=\"testing\",le=\"0.1\"} 56"));
    lines.push(String::from("response_time_bucket{env=\"testing\",le=\"0.25\"} 168"));
    lines.push(String::from("response_time_bucket{env=\"testing\",le=\"0.5\"} 338"));
